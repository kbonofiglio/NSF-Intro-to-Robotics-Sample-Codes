  //CAB 1.1.2022
//avoid.ino avoid.cpp
//robot avoid behavior uses proportional control or potential fields to slow down when approaching obstacles
//or move quickly away from an obstacle
...
void Avoid(){
  ...
  drive(dist,robotSpeed*(kp*error/wrnDistance));     //only move forward to test halt behavior
